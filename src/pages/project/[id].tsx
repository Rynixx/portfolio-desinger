    ...
    <div class="pt-page-moveFromRight">
      ...
      <div class="w-full justify-evenly flex flex-col-reverse mt-2 p-9 lg:flex-row ">
        <div>
          ...
          <p class="text-lg mt-5 mb-5 font-light max-w-xl">
            {projectData()?.fields.sectionText1.content[0].content[0].value}
            {projectData()?.fields.sectionText1.content[1]?.content[0].value}
          </p>
        </div>
      ...
      <div class="w-full justify-evenly flex flex-col-reverse pt-16 lg:flex-row p-9 bg-cyan-700 text-white">
        <div>
          ...
          <p class="text-lg mt-5 mb-5 font-light max-w-xl">
            {projectData()?.fields.sectionText2.content[0].content[0].value}
          </p>
        </div>
        <div class="lg:p-10 max-w-xl">
      ...
      <div class="w-full flex  flex-col pt-16 lg:flex-col p-9">
        <h1 class="text-3xl lg:ml-24 mt-5 mb-5 font-bold max-w-xl">
          {projectData()?.fields?.sectionHeading3}
        </h1>
        <p class="text-lg lg:ml-24 mt-5 mb-5 font-light max-w-xl">
          {projectData()?.fields.sectionText3?.content[0].content[0]?.value}
        </p>
      </div>
